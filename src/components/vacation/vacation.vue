<template>
  <div v-if=!stay class="stay">
    ...
    <section>
      <div class="stay-title">请假时间区间</div>
    ...
    <section v-show="isLeaveTag">
      <div class="stay-title">离校目的地</div>
      <div class="stay-content">
    ...
    <section v-show="isLeaveTag">
      <div class="stay-title">离校交通工具</div>
  ...
  <div class="stay" v-else-if=vacationTag2>
    <div v-show="oneTag" class="stay-success">撤销成功!</div>
    <div v-show="twoTag" class="stay-success">销假成功!</div>
    <sub>
